...
def multi_forecast_accuracy(candidate_key, next_n_frames_forecasts_report, forecast_window, sky_camera_images_files, sky_camera_images_dir):
    ...
    curr_index = sky_camera_images_files.index(candidate_key_filename)
    candidate_filenames = sky_camera_images_files[curr_index:(curr_index+forecast_window)]
